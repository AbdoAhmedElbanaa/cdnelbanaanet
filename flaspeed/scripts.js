        ...
        fetchData(BlogUrl + 'feeds/comments/default?alt=json&start-index=1&max-results=' + _0x5b6166, function () { }, function (_0x3ec6e1) {
            ...
            for (let _0x554143 = 0; _0x554143 < _0x1bbb89.length; _0x554143++) {
                ...
                _0x5b6d5e = _0x5b6d5e.replace(/(https?:\/\/[^\s<>"']+)/g, function (_0x29f233) {
                    ...
                    return '<a class="iscodilink" href="' + _0x29f233 + '" target="_blank" rel="nofollow noreferrer noopener">' + ExtLink + '</a>';
            ...
            _0x2adcc0.length && _0x2adcc0.forEach(_0x32feda => {
                !_0x32feda.classList.contains('iscodilink') && _0x32feda.classList.add('iscodilink');
            });
        }, function (_0x253e5c) {
        ...
        function _0x1bd254() {
            ...
            if (document.querySelector('.post-body a'))
                for (let _0x5acb6a = 0; _0x5acb6a < document.querySelectorAll('.post-body a').length; _0x5acb6a++) {
                    ...
                    if (!_0x4da619.closest('#redirect-page') && !_0x4da619.closest('.separator') && !_0x4da619.classList.contains('hidden-link') && !_0x4da619.classList.contains('iscodi-button') && !_0x4da619.querySelector('img')) {
                        _0x4da619.hasAttribute('target') && _0x4da619.getAttribute('target') === '_blank' ? _0x4da619.classList.add('external-iscodilink') : _0x4da619.classList.add('internal-iscodilink');
                    }
                }
        }
            ...
            function _0x4c89d8() {
                ...
                function _0x59c1b8(_0x367b9b) {
                    ...
                    _0x367b9b.innerHTML = _0x393a45.replace(/(https?:\/\/[^\s<>"']+)/g, function (_0x220110) {
                        ...
                        return '<a class="iscodilink" href="' + _0x220110 + '" rel="nofollow noreferrer noopener" target="_blank">' + ExtLink + '</a>';
                    });
                    const _0x42d9fe = _0x367b9b.querySelectorAll('a');
                    if (_0x42d9fe.length) {
                        _0x42d9fe.forEach(_0x950923 => {
                            if (!_0x950923.classList.contains('iscodilink')) {
                                _0x950923.classList.add('iscodilink');
                            }
                        });
                    }
                }
