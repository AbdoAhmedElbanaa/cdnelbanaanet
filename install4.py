...
rDownloadURL = {
    "main": "https://github.com/emre1393/xtreamui_mirror/releases/latest/download/main.tar.gz", 
    "sub": "https://github.com/emre1393/xtreamui_mirror/releases/latest/download/LB.tar.gz"
}
rPackages = [
    "libcurl3", "libxslt1-dev", "libgeoip-dev", "e2fsprogs", "wget", "mcrypt", 
    "nscd", "htop", "zip", "unzip", "mc", "libjemalloc1", "python-paramiko", "mysql-server"
]
rInstall = {"MAIN": "main", "LB": "sub"}

# فك التشفير مباشرة إلى bytes لمنع مشاكل ترميز UTF-8 في بايثون 3
rMySQLCnf = base64.b64decode(
    b"Iy "
)

rMySQLServiceFile = base64.b64decode(
    b"Iy "
)
...
def getVersion():
    try: 
        return subprocess.check_output("lsb_release -d".split()).decode("utf-8").split(":")[-1].strip()
    except: 
        return ""
...
def printc(rText, rColour=col.OKBLUE, rPadding=0):
    ...
    # استخدام القسمة الصحيحة // لمنع الأرقام العشرية في بايثون 3
    padding_left = 20 - (len(rText) // 2)
    padding_right = 40 - padding_left - len(rText)
    
    print("%s │ %s%s%s │ %s" % (rColour, " " * padding_left, rText, " " * padding_right, col.ENDC))
    for i in range(rPadding): 
        print("%s │                                          │ %s" % (rColour, col.ENDC))
    print("%s └──────────────────────────────────────────┘ %s" % (rColour, col.ENDC))
    print(" ")
...
def prepare(rType="MAIN"):
    ...
    os.system("apt-get install -y > /dev/null")  # تنظيف التثبيت
    try: 
...
def mysql(rUsername, rPassword):
    ...
    if rCreate:
        try:
            ...
            pass
        # كتابة ملف الإعدادات بصيغة ثنائية (bytes)
    ...
    for i in range(5):
        ...
        try:
            if rDrop:
                # استخدام النصوص الخام لمنع التحذيرات SyntaxWarning
                os.system(r'mysql -u root%s -e "DROP USER IF EXISTS \'%s\'@\'%%\'; DROP USER IF EXISTS \'%s\'@\'localhost\'; DROP USER IF EXISTS \'%s\'@\'127.0.0.1\';" > /dev/null' % (rExtra, rUsername, rUsername, rUsername))
                ...
                os.system(r'mysql -u root%s -e "USE xtream_iptvpro; UPDATE settings SET live_streaming_pass = \'%s\', unique_id = \'%s\', crypt_load_balancing = \'%s\', get_real_ip_client=\'\';" > /dev/null' % (rExtra, generate(20), generate(12), generate(20)))
                os.system(r'mysql -u root%s -e "USE xtream_iptvpro; REPLACE INTO streaming_servers (id, server_name, domain_name, server_ip, vpn_ip, ssh_password, ssh_port, diff_time_main, http_broadcast_port, total_clients, system_os, network_interface, latency, status, enable_geoip, geoip_countries, last_check_ago, can_delete, server_hardware, total_services, persistent_connections, rtmp_port, geoip_type, isp_names, isp_type, enable_isp, boost_fpm, http_ports_add, network_guaranteed_speed, https_broadcast_port, https_ports_add, whitelist_ips, watchdog_data, timeshift_only) VALUES (1, \'Main Server\', \'\', \'%s\', \'\', NULL, NULL, 0, 8080, 1000, \'%s\', \'eth0\', 0, 1, 0, \'\', 0, 0, \'{}\', 3, 0, 8880, \'low_priority\', \'\', \'low_priority\', 0, 1, \'\', 1000, 8443, \'\', \'[\"127.0.0.1\",\"\"]\', \'{}\', 0);" > /dev/null' % (rExtra, getIP(), getVersion()))
                os.system(r'mysql -u root%s -e "USE xtream_iptvpro; REPLACE INTO reg_users (id, username, password, email, member_group_id, verified, status) VALUES (1, \'admin\', \'\$6\$rounds=20000\$xtreamcodes\$XThC5OwfuS0YwS4ahiifzF14vkGbGsFF1w7ETL4sRRC5sOrAWCjWvQJDromZUQoQuwbAXAFdX3h3Cp3vqulpS0\', \'admin@website.com\', 1, 1, 1);" > /dev/null'  % rExtra)
                os.system(r'mysql -u root%s -e "CREATE USER \'%s\'@\'localhost\' IDENTIFIED BY \'%s\'; GRANT ALL PRIVILEGES ON xtream_iptvpro.* TO \'%s\'@\'localhost\' WITH GRANT OPTION; GRANT SELECT, PROCESS, LOCK TABLES ON *.* TO \'%s\'@\'localhost\';FLUSH PRIVILEGES;" > /dev/null' % (rExtra, rUsername, rPassword, rUsername, rUsername))
                os.system(r'mysql -u root%s -e "CREATE USER \'%s\'@\'127.0.0.1\' IDENTIFIED BY \'%s\'; GRANT ALL PRIVILEGES ON xtream_iptvpro.* TO \'%s\'@\'127.0.0.1\' WITH GRANT OPTION; GRANT SELECT, PROCESS, LOCK TABLES ON *.* TO \'%s\'@\'127.0.0.1\';FLUSH PRIVILEGES;" > /dev/null' % (rExtra, rUsername, rPassword, rUsername, rUsername))
                os.system(r'mysql -u root%s -e "GRANT SELECT, INSERT, UPDATE, DELETE ON xtream_iptvpro.* TO \'%s\'@\'%%\' IDENTIFIED BY \'%s\';FLUSH PRIVILEGES;" > /dev/null' % (rExtra, rUsername, rPassword))
                os.system(r'mysql -u root%s -e "USE xtream_iptvpro; CREATE TABLE IF NOT EXISTS dashboard_statistics (id int(11) NOT NULL AUTO_INCREMENT, type varchar(16) NOT NULL DEFAULT \'\', time int(16) NOT NULL DEFAULT \'0\', count int(16) NOT NULL DEFAULT \'0\', PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=latin1; INSERT INTO dashboard_statistics (type, time, count) VALUES(\'conns\', UNIX_TIMESTAMP(), 0),(\'users\', UNIX_TIMESTAMP(), 0);\" > /dev/null' % rExtra)
                os.system(r'mysql -u root%s -e "USE xtream_iptvpro; UPDATE settings SET get_real_ip_client=\'\', double_auth=\'1\', hash_lb=\'1\', mag_security=\'1\' where id=\'1\';" > /dev/null'  % rExtra)
                ...
                if not os.path.exists("/etc/mysql/mysqld"):
                    if not "EnvironmentFile=-/etc/mysql/mysqld" in open("/lib/systemd/system/mysql.service").read(): 
                        ...
                        # كتابة ملف الخدمة بأمان وصيغة ثنائية لتجنب مشاكل ترميز بايثون 3
                        with open('/lib/systemd/system/mysql.service', 'wb') as service_file:
                            service_file.write(rMySQLServiceFile)
...
def encrypt(rHost="127.0.0.1", rUsername="user_iptvpro", rPassword="", rDatabase="xtream_iptvpro", rServerID=1, rPort=7999):
    ...
    config_str = '{"host":"%s","db_user":"%s","db_pass":"%s","db_name":"%s","server_id":"%d", "db_port":"%d", "pconnect":"0"}' % (rHost, rUsername, rPassword, rDatabase, rServerID, rPort)
    key = '5709650b0d7806074842c6de575025b1'
    
    # عمليات XOR والتشفير لـ Python 3
    xor_bytes = bytes(ord(c) ^ ord(k) for c, k in zip(config_str, cycle(key)))
    encoded_str = base64.b64encode(xor_bytes).decode('utf-8').replace('\n', '')
    
    with open('/home/xtreamcodes/iptv_xtream_codes/config', 'w') as rf:
        rf.write(encoded_str)
...
def configure():
    ...
    if rType == "MAIN": 
        # استخدام النصوص الخام r"..." لمنع التحذيرات SyntaxWarning
        os.system(r"sudo find /home/xtreamcodes/iptv_xtream_codes/admin/ -type f -exec chmod 644 {} \;")
        os.system(r"sudo find /home/xtreamcodes/iptv_xtream_codes/admin/ -type d -exec chmod 755 {} \;")
    ...
    with open('/home/xtreamcodes/iptv_xtream_codes/nginx/conf/nginx.conf', 'r') as nginx_file:
        ...
        nginx_replace = nginx_replace.replace(
            r"rewrite ^/(.*)/(.*)/(\d+)$ /streaming/clients_live.php?username=$1&password=$2&stream=$3&extension=ts break;", 
    ...
    os.system(r"sudo find /home/xtreamcodes/iptv_xtream_codes/wwwdir/ -type f -exec chmod 644 {} \;")
    os.system(r"sudo find /home/xtreamcodes/iptv_xtream_codes/wwwdir/ -type d -exec chmod 755 {} \;")
